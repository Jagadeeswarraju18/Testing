...
const LandingPage: React.FC<{ onGetStarted: () => void }> = ({ onGetStarted }) => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans text-gray-900 overflow-x-hidden">
            ...
            {/* Hero Section */}
            <section className="relative pt-4 pb-8 lg:pt-12 lg:pb-32 overflow-hidden">
                <div className="max-w-[1400px] mx-auto px-6 flex flex-col lg:grid lg:grid-cols-2 gap-2 lg:gap-12 items-center">
                    ...
                    <div className="order-2 lg:order-2 relative h-[340px] lg:h-[550px] mt-0 lg:mt-0 w-full flex items-center justify-center lg:justify-center" style={{ perspective: '1200px' }}>
                    ...
                    <div className="order-1 lg:order-1 max-w-2xl relative z-10 text-center lg:text-left self-center">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-50 border border-indigo-100 text-indigo-700 text-[10px] font-bold uppercase tracking-wider mb-2 md:mb-6">
                        ...
                        <motion.p
                            ...
                            className="text-base sm:text-lg md:text-xl text-gray-500 mb-2 lg:mb-8 leading-relaxed max-w-lg mx-auto lg:mx-0"
                        >
